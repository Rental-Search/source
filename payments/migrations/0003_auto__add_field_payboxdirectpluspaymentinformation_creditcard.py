...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PayboxDirectPlusPaymentInformation.creditcard'
        db.add_column('payments_payboxdirectpluspaymentinformation', 'creditcard', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.CreditCard'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PayboxDirectPlusPaymentInformation.creditcard'
        db.delete_column('payments_payboxdirectpluspaymentinformation', 'creditcard_id')
