...
urlpatterns = patterns('',
    url(r'^%s/(?P<slug>[-\w]+)/$' % _('categorie'), CategoryDetailView.as_view(), name='category_homepage'),
    ...
    url(r'^([^/].+/)(?P<slug>[-\w]+)-(?P<pk>\d+)/$', ProductDetailView.as_view(), {'sqs': product_search}, name='booking_create'), #FIXME better name
