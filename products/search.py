...
product_search = SearchQuerySet().models(Product).filter(is_archived=False).facet('sites').facet('categories').facet('owner').facet('price').narrow('sites:%s' % settings.SITE_ID)
