...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique(u'products_category', ['slug'])

        # Adding model 'CategoryConformity'
        db.create_table(u'products_categoryconformity', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('eloue_category', self.gf('django.db.models.fields.related.OneToOneField')(related_name='+', unique=True, to=orm['products.Category'])),
            ('gosport_category', self.gf('django.db.models.fields.related.OneToOneField')(related_name='+', unique=True, to=orm['products.Category'])),
        ))
        db.send_create_signal(u'products', ['CategoryConformity'])
    ...
    def backwards(self, orm):
        # Deleting model 'CategoryConformity'
        db.delete_table(u'products_categoryconformity')
        ...
        db.create_unique(u'products_category', ['slug'])
    ...
    models = {
        ...
        u'products.categoryconformity': {
            ...
            'eloue_category': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'+'", 'unique': 'True', 'to': u"orm['products.Category']"}),
            'gosport_category': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'+'", 'unique': 'True', 'to': u"orm['products.Category']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
