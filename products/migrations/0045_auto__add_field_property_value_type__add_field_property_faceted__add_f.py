...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique(u'products_propertyvalue', ['property_id', 'product_id'])

        # Adding field 'Property.value_type'
        db.add_column(u'products_property', 'value_type',
                      self.gf('django.db.models.fields.CharField')(default='str', max_length=255),
                      keep_default=False)

        # Adding field 'Property.faceted'
        db.add_column(u'products_property', 'faceted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Property.default_str'
        db.add_column(u'products_property', 'default_str',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Property.max_str'
        db.add_column(u'products_property', 'max_str',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Property.min_str'
        db.add_column(u'products_property', 'min_str',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Property.choices_str'
        db.add_column(u'products_property', 'choices_str',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'PropertyValue.property'
        db.delete_column(u'products_propertyvalue', 'property_id')

        # Deleting field 'PropertyValue.value'
        db.delete_column(u'products_propertyvalue', 'value')

        # Adding field 'PropertyValue.property_type'
        db.add_column(u'products_propertyvalue', 'property_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='values', to=orm['products.Property']),
                      keep_default=False)

        # Adding field 'PropertyValue.value_str'
        db.add_column(u'products_propertyvalue', 'value_str',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding unique constraint on 'PropertyValue', fields ['property_type', 'product']
        db.create_unique(u'products_propertyvalue', ['property_type_id', 'product_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'PropertyValue', fields ['property_type', 'product']
        db.delete_unique(u'products_propertyvalue', ['property_type_id', 'product_id'])

        # Deleting field 'Property.value_type'
        db.delete_column(u'products_property', 'value_type')

        # Deleting field 'Property.faceted'
        db.delete_column(u'products_property', 'faceted')

        # Deleting field 'Property.default_str'
        db.delete_column(u'products_property', 'default_str')

        # Deleting field 'Property.max_str'
        db.delete_column(u'products_property', 'max_str')

        # Deleting field 'Property.min_str'
        db.delete_column(u'products_property', 'min_str')

        # Deleting field 'Property.choices_str'
        db.delete_column(u'products_property', 'choices_str')


        # User chose to not deal with backwards NULL issues for 'PropertyValue.property'
        raise RuntimeError("Cannot reverse this migration. 'PropertyValue.property' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'PropertyValue.property'
        db.add_column(u'products_propertyvalue', 'property',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='values', to=orm['products.Property']),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'PropertyValue.value'
        raise RuntimeError("Cannot reverse this migration. 'PropertyValue.value' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'PropertyValue.value'
        db.add_column(u'products_propertyvalue', 'value',
                      self.gf('django.db.models.fields.CharField')(max_length=255),
                      keep_default=False)

        # Deleting field 'PropertyValue.property_type'
        db.delete_column(u'products_propertyvalue', 'property_type_id')

        # Deleting field 'PropertyValue.value_str'
        db.delete_column(u'products_propertyvalue', 'value_str')

        # Adding unique constraint on 'PropertyValue', fields ['property', 'product']
        db.create_unique(u'products_propertyvalue', ['property_id', 'product_id'])
