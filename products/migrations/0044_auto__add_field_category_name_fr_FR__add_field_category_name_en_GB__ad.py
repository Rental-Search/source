...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Category.name_fr_FR'
        db.add_column(u'products_category', 'name_fr_FR',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Category.name_en_GB'
        db.add_column(u'products_category', 'name_en_GB',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Category.name_da_DK'
        db.add_column(u'products_category', 'name_da_DK',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Category.slug_fr_FR'
        db.add_column(u'products_category', 'slug_fr_FR',
                      self.gf('django.db.models.fields.SlugField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Category.slug_en_GB'
        db.add_column(u'products_category', 'slug_en_GB',
                      self.gf('django.db.models.fields.SlugField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Category.slug_da_DK'
        db.add_column(u'products_category', 'slug_da_DK',
                      self.gf('django.db.models.fields.SlugField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Category.title_fr_FR'
        db.add_column(u'products_category', 'title_fr_FR',
                      self.gf('django.db.models.fields.CharField')(max_length=150, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Category.title_en_GB'
        db.add_column(u'products_category', 'title_en_GB',
                      self.gf('django.db.models.fields.CharField')(max_length=150, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Category.title_da_DK'
        db.add_column(u'products_category', 'title_da_DK',
                      self.gf('django.db.models.fields.CharField')(max_length=150, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Category.description_fr_FR'
        db.add_column(u'products_category', 'description_fr_FR',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Category.description_en_GB'
        db.add_column(u'products_category', 'description_en_GB',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Category.description_da_DK'
        db.add_column(u'products_category', 'description_da_DK',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Category.header_fr_FR'
        db.add_column(u'products_category', 'header_fr_FR',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Category.header_en_GB'
        db.add_column(u'products_category', 'header_en_GB',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Category.header_da_DK'
        db.add_column(u'products_category', 'header_da_DK',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Category.footer_fr_FR'
        db.add_column(u'products_category', 'footer_fr_FR',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Category.footer_en_GB'
        db.add_column(u'products_category', 'footer_en_GB',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Category.footer_da_DK'
        db.add_column(u'products_category', 'footer_da_DK',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Category.image_fr_FR'
        db.add_column(u'products_category', 'image_fr_FR',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Category.image_en_GB'
        db.add_column(u'products_category', 'image_en_GB',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Category.image_da_DK'
        db.add_column(u'products_category', 'image_da_DK',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Category.name_fr_FR'
        db.delete_column(u'products_category', 'name_fr_FR')

        # Deleting field 'Category.name_en_GB'
        db.delete_column(u'products_category', 'name_en_GB')

        # Deleting field 'Category.name_da_DK'
        db.delete_column(u'products_category', 'name_da_DK')

        # Deleting field 'Category.slug_fr_FR'
        db.delete_column(u'products_category', 'slug_fr_FR')

        # Deleting field 'Category.slug_en_GB'
        db.delete_column(u'products_category', 'slug_en_GB')

        # Deleting field 'Category.slug_da_DK'
        db.delete_column(u'products_category', 'slug_da_DK')

        # Deleting field 'Category.title_fr_FR'
        db.delete_column(u'products_category', 'title_fr_FR')

        # Deleting field 'Category.title_en_GB'
        db.delete_column(u'products_category', 'title_en_GB')

        # Deleting field 'Category.title_da_DK'
        db.delete_column(u'products_category', 'title_da_DK')

        # Deleting field 'Category.description_fr_FR'
        db.delete_column(u'products_category', 'description_fr_FR')

        # Deleting field 'Category.description_en_GB'
        db.delete_column(u'products_category', 'description_en_GB')

        # Deleting field 'Category.description_da_DK'
        db.delete_column(u'products_category', 'description_da_DK')

        # Deleting field 'Category.header_fr_FR'
        db.delete_column(u'products_category', 'header_fr_FR')

        # Deleting field 'Category.header_en_GB'
        db.delete_column(u'products_category', 'header_en_GB')

        # Deleting field 'Category.header_da_DK'
        db.delete_column(u'products_category', 'header_da_DK')

        # Deleting field 'Category.footer_fr_FR'
        db.delete_column(u'products_category', 'footer_fr_FR')

        # Deleting field 'Category.footer_en_GB'
        db.delete_column(u'products_category', 'footer_en_GB')

        # Deleting field 'Category.footer_da_DK'
        db.delete_column(u'products_category', 'footer_da_DK')

        # Deleting field 'Category.image_fr_FR'
        db.delete_column(u'products_category', 'image_fr_FR')

        # Deleting field 'Category.image_en_GB'
        db.delete_column(u'products_category', 'image_en_GB')

        # Deleting field 'Category.image_da_DK'
        db.delete_column(u'products_category', 'image_da_DK')
    ...
    models = {
        ...
        u'products.category': {
            ...
            'description_da_DK': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'description_en_GB': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'description_fr_FR': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'footer': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'footer_da_DK': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'footer_en_GB': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'footer_fr_FR': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'header': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'header_da_DK': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'header_en_GB': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'header_fr_FR': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'image_da_DK': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'image_en_GB': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'image_fr_FR': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            u'level': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            u'lft': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'name_da_DK': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'name_en_GB': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'name_fr_FR': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            ...
            'slug_da_DK': ('django.db.models.fields.SlugField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'slug_en_GB': ('django.db.models.fields.SlugField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'slug_fr_FR': ('django.db.models.fields.SlugField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '150', 'blank': 'True'}),
            'title_da_DK': ('django.db.models.fields.CharField', [], {'max_length': '150', 'null': 'True', 'blank': 'True'}),
            'title_en_GB': ('django.db.models.fields.CharField', [], {'max_length': '150', 'null': 'True', 'blank': 'True'}),
            'title_fr_FR': ('django.db.models.fields.CharField', [], {'max_length': '150', 'null': 'True', 'blank': 'True'}),
