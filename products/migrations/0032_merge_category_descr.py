...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        """Move data from category description to category."""
        descriptions = orm.CategoryDescription.objects.select_related('category')

        for description in descriptions:
            category = description.category
            category.title = description.title
            category.description = description.description
            category.header = description.header
            category.footer = description.footer
            category.save()

    def backwards(self, orm):
        """Move data from category to category description."""

        categories = orm.Category.objects.exclude(
            title='', text='',
            header='', footer='')
        ...
        for category in categories:
            try:
            ...
            except orm.CategoryDescription.DoesNotExist:
                orm.CategoryDescription.objects.create(
                    category=category,
                ...
                description.header = category.header
                description.footer = category.footer
                description.save()
