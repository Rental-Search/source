...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Product.modified_at'
        db.add_column('products_product', 'modified_at', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Product.modified_at'
        db.delete_column('products_product', 'modified_at')
