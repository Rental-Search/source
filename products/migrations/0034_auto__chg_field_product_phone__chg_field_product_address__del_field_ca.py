...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Product.phone'
        db.alter_column(u'products_product', 'phone_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.PROTECT, to=orm['accounts.PhoneNumber']))

        # Changing field 'Product.address'
        db.alter_column(u'products_product', 'address_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.PROTECT, to=orm['accounts.Address']))

    def backwards(self, orm):

        # Changing field 'Product.phone'
        db.alter_column(u'products_product', 'phone_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['accounts.PhoneNumber']))

        # Changing field 'Product.address'
        db.alter_column(u'products_product', 'address_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.Address']))
