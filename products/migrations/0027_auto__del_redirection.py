...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table('products_redirection', (
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(related_name='redirections', null=True, to=orm['products.Product'], blank=True)),
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 25, 19, 8, 49, 662761)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 25, 19, 8, 49, 662641)'}),
