...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for curiosity in orm.Curiosity.objects.all():
            curiosity.sites.add(site.pk)
        for category in orm.Category.objects.all():
            category.sites.add(site.pk)
    ...
    def backwards(self, orm):
        ...
        for curiosity in orm.Curiosity.objects.all():
            curiosity.sites.remove(site.pk)
        for category in orm.Category.objects.all():
            category.sites.remove(site.pk)
