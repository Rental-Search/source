...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'products_categorydescription')


    def backwards(self, orm):
        # Adding model 'CategoryDescription'
        db.create_table(u'products_categorydescription', (
            ('category', self.gf('django.db.models.fields.related.OneToOneField')(related_name='description', unique=True, to=orm['products.Category'])),
        ...
        db.send_create_signal(u'products', ['CategoryDescription'])
