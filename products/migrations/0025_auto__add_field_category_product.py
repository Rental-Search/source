...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Category.product'
        db.add_column('products_category', 'product', self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name='category_product', unique=True, null=True, to=orm['products.Product']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Category.product'
        db.delete_column('products_category', 'product_id')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 14, 17, 24, 3, 869820)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 14, 17, 24, 3, 869704)'}),
