...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Product.phone'
        db.add_column('products_product', 'phone', self.gf('django.db.models.fields.related.ForeignKey')(related_name='products', null=True, to=orm['accounts.PhoneNumber']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Product.phone'
        db.delete_column('products_product', 'phone_id')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 10, 17, 32, 5, 512907)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 10, 17, 32, 5, 512803)'}),
        ...
        'products.product': {
            ...
            'phone': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'products'", 'null': 'True', 'to': "orm['accounts.PhoneNumber']"}),
            'pro_agencies': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'products'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['accounts.ProAgency']"}),
