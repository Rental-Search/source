...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'Price', fields ['product', 'name', 'unit']
        db.delete_unique('products_price', ['product_id', 'name', 'unit'])


    def backwards(self, orm):
        
        # Adding unique constraint on 'Price', fields ['product', 'name', 'unit']
        db.create_unique('products_price', ['product_id', 'name', 'unit'])
