...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Property.attr_name'
        db.add_column(u'products_property', 'attr_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Property.attr_name'
        db.delete_column(u'products_property', 'attr_name')
