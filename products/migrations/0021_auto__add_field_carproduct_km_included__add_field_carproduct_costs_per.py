...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CarProduct.km_included'
        db.add_column('products_carproduct', 'km_included', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'CarProduct.costs_per_km'
        db.add_column('products_carproduct', 'costs_per_km', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=3, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CarProduct.km_included'
        db.delete_column('products_carproduct', 'km_included')

        # Deleting field 'CarProduct.costs_per_km'
        db.delete_column('products_carproduct', 'costs_per_km')
