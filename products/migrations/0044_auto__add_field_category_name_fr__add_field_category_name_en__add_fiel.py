...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'products_category', 'name_fr',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Category.name_en'
        db.add_column(u'products_category', 'name_en',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Category.name_da'
        db.add_column(u'products_category', 'name_da',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Category.slug_fr'
        db.add_column(u'products_category', 'slug_fr',
                      self.gf('django.db.models.fields.SlugField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Category.slug_en'
        db.add_column(u'products_category', 'slug_en',
                      self.gf('django.db.models.fields.SlugField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Category.slug_da'
        db.add_column(u'products_category', 'slug_da',
                      self.gf('django.db.models.fields.SlugField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Category.title_fr'
        db.add_column(u'products_category', 'title_fr',
                      self.gf('django.db.models.fields.CharField')(max_length=150, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Category.title_en'
        db.add_column(u'products_category', 'title_en',
                      self.gf('django.db.models.fields.CharField')(max_length=150, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Category.title_da'
        db.add_column(u'products_category', 'title_da',
                      self.gf('django.db.models.fields.CharField')(max_length=150, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Category.description_fr'
        db.add_column(u'products_category', 'description_fr',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Category.description_en'
        db.add_column(u'products_category', 'description_en',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Category.description_da'
        db.add_column(u'products_category', 'description_da',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Category.header_fr'
        db.add_column(u'products_category', 'header_fr',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Category.header_en'
        db.add_column(u'products_category', 'header_en',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Category.header_da'
        db.add_column(u'products_category', 'header_da',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Category.footer_fr'
        db.add_column(u'products_category', 'footer_fr',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Category.footer_en'
        db.add_column(u'products_category', 'footer_en',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Category.footer_da'
        db.add_column(u'products_category', 'footer_da',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Category.image_fr'
        db.add_column(u'products_category', 'image_fr',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Category.image_en'
        db.add_column(u'products_category', 'image_en',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Category.image_da'
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'products_category', 'name_fr')

        # Deleting field 'Category.name_en'
        db.delete_column(u'products_category', 'name_en')

        # Deleting field 'Category.name_da'
        db.delete_column(u'products_category', 'name_da')

        # Deleting field 'Category.slug_fr'
        db.delete_column(u'products_category', 'slug_fr')

        # Deleting field 'Category.slug_en'
        db.delete_column(u'products_category', 'slug_en')

        # Deleting field 'Category.slug_da'
        db.delete_column(u'products_category', 'slug_da')

        # Deleting field 'Category.title_fr'
        db.delete_column(u'products_category', 'title_fr')

        # Deleting field 'Category.title_en'
        db.delete_column(u'products_category', 'title_en')

        # Deleting field 'Category.title_da'
        db.delete_column(u'products_category', 'title_da')

        # Deleting field 'Category.description_fr'
        db.delete_column(u'products_category', 'description_fr')

        # Deleting field 'Category.description_en'
        db.delete_column(u'products_category', 'description_en')

        # Deleting field 'Category.description_da'
        db.delete_column(u'products_category', 'description_da')

        # Deleting field 'Category.header_fr'
        db.delete_column(u'products_category', 'header_fr')

        # Deleting field 'Category.header_en'
        db.delete_column(u'products_category', 'header_en')

        # Deleting field 'Category.header_da'
        db.delete_column(u'products_category', 'header_da')

        # Deleting field 'Category.footer_fr'
        db.delete_column(u'products_category', 'footer_fr')

        # Deleting field 'Category.footer_en'
        db.delete_column(u'products_category', 'footer_en')

        # Deleting field 'Category.footer_da'
        db.delete_column(u'products_category', 'footer_da')

        # Deleting field 'Category.image_fr'
        db.delete_column(u'products_category', 'image_fr')

        # Deleting field 'Category.image_en'
        db.delete_column(u'products_category', 'image_en')
