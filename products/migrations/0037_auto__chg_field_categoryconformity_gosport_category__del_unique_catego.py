...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'CategoryConformity', fields ['eloue_category']
        db.delete_unique(u'products_categoryconformity', ['eloue_category_id'])

        # Removing unique constraint on 'CategoryConformity', fields ['gosport_category']
        db.delete_unique(u'products_categoryconformity', ['gosport_category_id'])


        # Changing field 'CategoryConformity.gosport_category'
        db.alter_column(u'products_categoryconformity', 'gosport_category_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['products.Category']))

        # Changing field 'CategoryConformity.eloue_category'
        db.alter_column(u'products_categoryconformity', 'eloue_category_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['products.Category']))

    def backwards(self, orm):

        # Changing field 'CategoryConformity.gosport_category'
        db.alter_column(u'products_categoryconformity', 'gosport_category_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['products.Category']))
        # Adding unique constraint on 'CategoryConformity', fields ['gosport_category']
        db.create_unique(u'products_categoryconformity', ['gosport_category_id'])


        # Changing field 'CategoryConformity.eloue_category'
        db.alter_column(u'products_categoryconformity', 'eloue_category_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['products.Category']))
        # Adding unique constraint on 'CategoryConformity', fields ['eloue_category']
        db.create_unique(u'products_categoryconformity', ['eloue_category_id'])
