...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Product.redirect_url'
        db.alter_column(u'products_product', 'redirect_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

    def backwards(self, orm):

        # Changing field 'Product.redirect_url'
        db.alter_column(u'products_product', 'redirect_url', self.gf('django.db.models.fields.URLField')(default='', max_length=200))
