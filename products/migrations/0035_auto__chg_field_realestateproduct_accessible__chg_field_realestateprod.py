...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'products_realestateproduct', 'accessible', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'RealEstateProduct.jacuzzi'
        db.alter_column(u'products_realestateproduct', 'jacuzzi', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'RealEstateProduct.parking'
        db.alter_column(u'products_realestateproduct', 'parking', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'RealEstateProduct.ideal_for_events'
        db.alter_column(u'products_realestateproduct', 'ideal_for_events', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'RealEstateProduct.breakfast'
        db.alter_column(u'products_realestateproduct', 'breakfast', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'RealEstateProduct.balcony'
        db.alter_column(u'products_realestateproduct', 'balcony', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'RealEstateProduct.tv'
        db.alter_column(u'products_realestateproduct', 'tv', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'RealEstateProduct.computer_with_internet'
        db.alter_column(u'products_realestateproduct', 'computer_with_internet', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'RealEstateProduct.lockable_chamber'
        db.alter_column(u'products_realestateproduct', 'lockable_chamber', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'RealEstateProduct.smoking_accepted'
        db.alter_column(u'products_realestateproduct', 'smoking_accepted', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'RealEstateProduct.gym'
        db.alter_column(u'products_realestateproduct', 'gym', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'RealEstateProduct.lift'
        db.alter_column(u'products_realestateproduct', 'lift', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'RealEstateProduct.tumble_dryer'
        db.alter_column(u'products_realestateproduct', 'tumble_dryer', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'RealEstateProduct.air_conditioning'
        db.alter_column(u'products_realestateproduct', 'air_conditioning', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'RealEstateProduct.family_friendly'
        db.alter_column(u'products_realestateproduct', 'family_friendly', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'RealEstateProduct.chimney'
        db.alter_column(u'products_realestateproduct', 'chimney', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'RealEstateProduct.kitchen'
        db.alter_column(u'products_realestateproduct', 'kitchen', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'RealEstateProduct.towel'
        db.alter_column(u'products_realestateproduct', 'towel', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'RealEstateProduct.heating'
        db.alter_column(u'products_realestateproduct', 'heating', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'RealEstateProduct.washing_machine'
        db.alter_column(u'products_realestateproduct', 'washing_machine', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'RealEstateProduct.internet_access'
        db.alter_column(u'products_realestateproduct', 'internet_access', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'CarProduct.audio_input'
        db.alter_column(u'products_carproduct', 'audio_input', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'CarProduct.bike_rack'
        db.alter_column(u'products_carproduct', 'bike_rack', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'CarProduct.cruise_control'
        db.alter_column(u'products_carproduct', 'cruise_control', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'CarProduct.baby_seat'
        db.alter_column(u'products_carproduct', 'baby_seat', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'CarProduct.snow_tires'
        db.alter_column(u'products_carproduct', 'snow_tires', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'CarProduct.gps'
        db.alter_column(u'products_carproduct', 'gps', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'CarProduct.cd_player'
        db.alter_column(u'products_carproduct', 'cd_player', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'CarProduct.air_conditioning'
        db.alter_column(u'products_carproduct', 'air_conditioning', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'CarProduct.power_steering'
        db.alter_column(u'products_carproduct', 'power_steering', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'CarProduct.snow_chains'
        db.alter_column(u'products_carproduct', 'snow_chains', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'CarProduct.roof_box'
        db.alter_column(u'products_carproduct', 'roof_box', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'CarProduct.ski_rack'
        db.alter_column(u'products_carproduct', 'ski_rack', self.gf('django.db.models.fields.NullBooleanField')(null=True))

    def backwards(self, orm):

        # Changing field 'RealEstateProduct.accessible'
        db.alter_column(u'products_realestateproduct', 'accessible', self.gf('django.db.models.fields.BooleanField')(default=False))

        # Changing field 'RealEstateProduct.jacuzzi'
        db.alter_column(u'products_realestateproduct', 'jacuzzi', self.gf('django.db.models.fields.BooleanField')(default=False))

        # Changing field 'RealEstateProduct.parking'
        db.alter_column(u'products_realestateproduct', 'parking', self.gf('django.db.models.fields.BooleanField')(default=False))

        # Changing field 'RealEstateProduct.ideal_for_events'
        db.alter_column(u'products_realestateproduct', 'ideal_for_events', self.gf('django.db.models.fields.BooleanField')(default=False))

        # Changing field 'RealEstateProduct.breakfast'
        db.alter_column(u'products_realestateproduct', 'breakfast', self.gf('django.db.models.fields.BooleanField')(default=False))

        # Changing field 'RealEstateProduct.balcony'
        db.alter_column(u'products_realestateproduct', 'balcony', self.gf('django.db.models.fields.BooleanField')(default=False))

        # Changing field 'RealEstateProduct.tv'
        db.alter_column(u'products_realestateproduct', 'tv', self.gf('django.db.models.fields.BooleanField')(default=False))

        # Changing field 'RealEstateProduct.computer_with_internet'
        db.alter_column(u'products_realestateproduct', 'computer_with_internet', self.gf('django.db.models.fields.BooleanField')(default=False))

        # Changing field 'RealEstateProduct.lockable_chamber'
        db.alter_column(u'products_realestateproduct', 'lockable_chamber', self.gf('django.db.models.fields.BooleanField')(default=False))

        # Changing field 'RealEstateProduct.smoking_accepted'
        db.alter_column(u'products_realestateproduct', 'smoking_accepted', self.gf('django.db.models.fields.BooleanField')(default=False))

        # Changing field 'RealEstateProduct.gym'
        db.alter_column(u'products_realestateproduct', 'gym', self.gf('django.db.models.fields.BooleanField')(default=False))

        # Changing field 'RealEstateProduct.lift'
        db.alter_column(u'products_realestateproduct', 'lift', self.gf('django.db.models.fields.BooleanField')(default=False))

        # Changing field 'RealEstateProduct.tumble_dryer'
        db.alter_column(u'products_realestateproduct', 'tumble_dryer', self.gf('django.db.models.fields.BooleanField')(default=False))

        # Changing field 'RealEstateProduct.air_conditioning'
        db.alter_column(u'products_realestateproduct', 'air_conditioning', self.gf('django.db.models.fields.BooleanField')(default=False))

        # Changing field 'RealEstateProduct.family_friendly'
        db.alter_column(u'products_realestateproduct', 'family_friendly', self.gf('django.db.models.fields.BooleanField')(default=False))

        # Changing field 'RealEstateProduct.chimney'
        db.alter_column(u'products_realestateproduct', 'chimney', self.gf('django.db.models.fields.BooleanField')(default=False))

        # Changing field 'RealEstateProduct.kitchen'
        db.alter_column(u'products_realestateproduct', 'kitchen', self.gf('django.db.models.fields.BooleanField')(default=False))

        # Changing field 'RealEstateProduct.towel'
        db.alter_column(u'products_realestateproduct', 'towel', self.gf('django.db.models.fields.BooleanField')(default=False))

        # Changing field 'RealEstateProduct.heating'
        db.alter_column(u'products_realestateproduct', 'heating', self.gf('django.db.models.fields.BooleanField')(default=False))

        # Changing field 'RealEstateProduct.washing_machine'
        db.alter_column(u'products_realestateproduct', 'washing_machine', self.gf('django.db.models.fields.BooleanField')(default=False))

        # Changing field 'RealEstateProduct.internet_access'
        db.alter_column(u'products_realestateproduct', 'internet_access', self.gf('django.db.models.fields.BooleanField')(default=False))

        # Changing field 'CarProduct.audio_input'
        db.alter_column(u'products_carproduct', 'audio_input', self.gf('django.db.models.fields.BooleanField')(default=False))

        # Changing field 'CarProduct.bike_rack'
        db.alter_column(u'products_carproduct', 'bike_rack', self.gf('django.db.models.fields.BooleanField')(default=False))

        # Changing field 'CarProduct.cruise_control'
        db.alter_column(u'products_carproduct', 'cruise_control', self.gf('django.db.models.fields.BooleanField')(default=False))

        # Changing field 'CarProduct.baby_seat'
        db.alter_column(u'products_carproduct', 'baby_seat', self.gf('django.db.models.fields.BooleanField')(default=False))

        # Changing field 'CarProduct.snow_tires'
        db.alter_column(u'products_carproduct', 'snow_tires', self.gf('django.db.models.fields.BooleanField')(default=False))

        # Changing field 'CarProduct.gps'
        db.alter_column(u'products_carproduct', 'gps', self.gf('django.db.models.fields.BooleanField')(default=False))

        # Changing field 'CarProduct.cd_player'
        db.alter_column(u'products_carproduct', 'cd_player', self.gf('django.db.models.fields.BooleanField')(default=False))

        # Changing field 'CarProduct.air_conditioning'
        db.alter_column(u'products_carproduct', 'air_conditioning', self.gf('django.db.models.fields.BooleanField')(default=False))

        # Changing field 'CarProduct.power_steering'
        db.alter_column(u'products_carproduct', 'power_steering', self.gf('django.db.models.fields.BooleanField')(default=False))

        # Changing field 'CarProduct.snow_chains'
        db.alter_column(u'products_carproduct', 'snow_chains', self.gf('django.db.models.fields.BooleanField')(default=False))

        # Changing field 'CarProduct.roof_box'
        db.alter_column(u'products_carproduct', 'roof_box', self.gf('django.db.models.fields.BooleanField')(default=False))

        # Changing field 'CarProduct.ski_rack'
        db.alter_column(u'products_carproduct', 'ski_rack', self.gf('django.db.models.fields.BooleanField')(default=False))
