...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('products_redirection', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('patron', self.gf('django.db.models.fields.related.ForeignKey')(related_name='redirections', to=orm['accounts.Patron'])),
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='redirections', null=True, to=orm['products.Product'])),
            ('redirect_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('redirection_url', self.gf('django.db.models.fields.URLField')(max_length=200)),
        ))
        db.send_create_signal('products', ['Redirection'])


    def backwards(self, orm):
        
        # Deleting model 'Redirection'
        db.delete_table('products_redirection')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 15, 17, 56, 4, 223424)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 15, 17, 56, 4, 223299)'}),
        ...
        'products.redirection': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'patron': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'redirections'", 'to': "orm['accounts.Patron']"}),
            'product': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'redirections'", 'null': 'True', 'to': "orm['products.Product']"}),
            'redirect_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'redirection_url': ('django.db.models.fields.URLField', [], {'max_length': '200'})
        },
        'rent.booking': {
