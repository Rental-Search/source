...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('payments', ['PaypalPaymentInformation'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'PayboxDirectPaymentInformation'
        db.delete_table('payments_payboxdirectpaymentinformation')

        # Deleting model 'PayboxDirectPlusPaymentInformation'
        db.delete_table('payments_payboxdirectpluspaymentinformation')
