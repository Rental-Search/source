...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'accounts_avatar')


    def backwards(self, orm):
        # Adding model 'Avatar'
        db.create_table(u'accounts_avatar', (
            ('patron', self.gf('django.db.models.fields.related.OneToOneField')(related_name='avatar_old', unique=True, to=orm['auth.User'])),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('image', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
        ))
        db.send_create_signal('accounts', ['Avatar'])
    ...
    models = {
        ...
        u'accounts.patron': {
            'Meta': {'object_name': 'Patron', '_ormbases': [u'auth.User']},
