...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Patron.rib'
        db.add_column('accounts_patron', 'rib', self.gf('django.db.models.fields.CharField')(default='', max_length=23, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Patron.rib'
        db.delete_column('accounts_patron', 'rib')
