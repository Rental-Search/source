...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Patron.new_messages_alerted'
        db.add_column('accounts_patron', 'new_messages_alerted', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Patron.new_messages_alerted'
        db.delete_column('accounts_patron', 'new_messages_alerted')
