...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'Patron.site'
        db.add_column('accounts_patron', 'site', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='patrons', to=orm['sites.Site']), keep_default=False)
    
    def backwards(self, orm):
        # Deleting field 'Patron.site'
        db.delete_column('accounts_patron', 'site_id')
