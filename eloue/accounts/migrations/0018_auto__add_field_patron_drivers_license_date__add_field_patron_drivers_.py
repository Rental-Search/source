...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Patron.drivers_license_date'
        db.add_column('accounts_patron', 'drivers_license_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'Patron.drivers_license_number'
        db.add_column('accounts_patron', 'drivers_license_number', self.gf('django.db.models.fields.CharField')(default='', max_length=32, blank=True), keep_default=False)

        # Adding field 'Patron.date_of_birth'
        db.add_column('accounts_patron', 'date_of_birth', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'Patron.place_of_birth'
        db.add_column('accounts_patron', 'place_of_birth', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)

        # Adding field 'CreditCard.keep'
        db.add_column('accounts_creditcard', 'keep', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Patron.drivers_license_date'
        db.delete_column('accounts_patron', 'drivers_license_date')

        # Deleting field 'Patron.drivers_license_number'
        db.delete_column('accounts_patron', 'drivers_license_number')

        # Deleting field 'Patron.date_of_birth'
        db.delete_column('accounts_patron', 'date_of_birth')

        # Deleting field 'Patron.place_of_birth'
        db.delete_column('accounts_patron', 'place_of_birth')

        # Deleting field 'CreditCard.keep'
        db.delete_column('accounts_creditcard', 'keep')
