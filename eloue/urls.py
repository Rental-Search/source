...
urlpatterns = patterns('',
    ...
    url(r'^dashboard/borrower/booking/pending/$', 'eloue.accounts.views.borrower_booking_pending', name="borrower_booking_pending"),
    url(r'^dashboard/borrower/booking/ongoing/$', 'eloue.accounts.views.borrower_booking_ongoing', name="borrower_booking_ongoing"),
    url(r'^dashboard/borrower/booking/authorized/$', 'eloue.accounts.views.borrower_booking_authorized', name="borrower_booking_authorized"),
    url(r'^dashboard/borrower/booking/history/$', 'eloue.accounts.views.borrower_booking_history', name="borrower_booking_history"),
    url(r'^dashboard/borrower/booking/pending/(?P<page>\d+)/$', 'eloue.accounts.views.borrower_booking_pending', name="borrower_booking_pending"),
    url(r'^dashboard/borrower/booking/ongoing/(?P<page>\d+)/$', 'eloue.accounts.views.borrower_booking_ongoing', name="borrower_booking_ongoing"),
    url(r'^dashboard/borrower/booking/authorized/(?P<page>\d+)/$', 'eloue.accounts.views.borrower_booking_authorized', name="borrower_booking_authorized"),
    url(r'^dashboard/borrower/booking/history/(?P<page>\d+)/$', 'eloue.accounts.views.borrower_booking_history', name="borrower_booking_history"),
