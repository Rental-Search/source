            ...
            $scope.saveCardAndRequestBooking = function (defaultAddress) {
                ...
                if ($scope.isAuto) {
                    ...
                    if ($scope.currentUser.drivers_license_date) {
                        userPatch.drivers_license_date = UtilsService.formatDate(Date.parse($scope.currentUser.drivers_license_date), "yyyy-MM-dd'T'HH:mm");
                    }
                    userPatch.place_of_birth = $scope.currentUser.place_of_birth;
                    if ($scope.currentUser.date_of_birth) {
                        userPatch.date_of_birth = UtilsService.formatDate(Date.parse($scope.currentUser.date_of_birth), "yyyy-MM-dd'T'HH:mm");
                    }
                }
