require.config({
    baseUrl: STATIC_URL + "static/js/widgets",
    paths: {
        "bootstrap": STATIC_URL + "static/bower_components/bootstrap/dist/js/bootstrap.min",
        "lodash": STATIC_URL + "static/bower_components/lodash/dist/lodash.min",
        "jQuery": STATIC_URL + "static/bower_components/jquery/dist/jquery.min",
        "jquery-ui": STATIC_URL + "static/bower_components/jqueryui/jquery-ui.min",
        "jshashtable": STATIC_URL + "static/js/jshashtable-2.1_src",
        "jquery.numberformatter": STATIC_URL + "static/js/jquery.numberformatter-1.2.3",
        "tmpl": STATIC_URL + "static/js/tmpl",
        "jquery.dependClass": STATIC_URL + "static/js/jquery.dependClass-0.1",
        "draggable": STATIC_URL + "static/js/draggable-0.1",
        "slider": STATIC_URL + "static/js/jquery.slider",
        "core": STATIC_URL + "static/bower_components/jqueryui/ui/minified/core.min",
        "mouse": STATIC_URL + "static/bower_components/jqueryui/ui/minified/mouse.min",
        "widget": STATIC_URL + "static/bower_components/jqueryui/ui/minified/widget.min",
        "angular": STATIC_URL + "static/bower_components/angular/angular.min",
        "angular-resource": STATIC_URL + "static/bower_components/angular-resource/angular-resource.min",
        "angular-route": STATIC_URL + "static/bower_components/angular-route/angular-route.min",
        "angular-cookies": STATIC_URL + "static/bower_components/angular-cookies/angular-cookies.min",
        "angular-sanitize": STATIC_URL + "static/bower_components/angular-sanitize/angular-sanitize.min",
        "moment": STATIC_URL + "static/bower_components/moment/min/moment.min",
        "angular-moment": STATIC_URL + "static/bower_components/angular-moment/angular-moment.min",
        "bootstrap-datepicker": STATIC_URL + "static/bower_components/bootstrap-datepicker/js/bootstrap-datepicker",
        "bootstrap-datepicker-fr": STATIC_URL + "static/bower_components/bootstrap-datepicker/js/locales/bootstrap-datepicker.fr",
        "jquery-form": STATIC_URL + "static/bower_components/jquery-form/jquery.form",
        "datejs": STATIC_URL + "static/bower_components/datejs/build/production/date.min",
        "chosen": STATIC_URL + "static/bower_components/chosen/chosen.jquery.min",
        "html5shiv": STATIC_URL + "static/bower_components/html5shiv/dist/html5shiv.min",
        "respond": STATIC_URL + "static/bower_components/respond/respond.min",
        "placeholders-utils": STATIC_URL + "static/bower_components/placeholders/lib/utils",
        "placeholders-main": STATIC_URL + "static/bower_components/placeholders/lib/main",
        "placeholders-jquery": STATIC_URL + "static/bower_components/placeholders/lib/adapters/placeholders.jquery",
        "custom-scrollbar": STATIC_URL + "static/bower_components/malihu-custom-scrollbar-plugin/jquery.mCustomScrollbar",
        "jquery-mousewheel": STATIC_URL + "static/bower_components/jquery-mousewheel/jquery.mousewheel",
        "toastr": STATIC_URL + "static/bower_components/toastr/toastr.min",
        "formmapper": STATIC_URL + "static/js/formmapper"
    },
    shim: {
