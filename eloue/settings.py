...
PIPELINE_JS = {
    ...
    'proapp': {
        'source_filenames': (
            ...
            'proapp/js/views/ads/adsinfo.js',
            'proapp/js/views/ads/adspic.js',
            'proapp/js/views/ads/adsprice.js',
            ...
            'proapp/js/views/accounts/billingtabcontent.js',
            'proapp/js/views/accounts/plantabcontent.js',
            'proapp/js/views/accounts/accountspillcontent.js',
