...
if DEBUG:
    ...
    QUEUE_BACKEND = 'eloue.redisd_backend'
QUEUE_REDIS_CONNECTION = env('QUEUE_REDIS_CONNECTION', 'redis://localhost:6379')
QUEUE_REDIS_CONNECTION_PASSWORD = env('QUEUE_REDIS_CONNECTION_PASSWORD', None)
