...
module.exports = function (config) {
    config.set({
        ...
        files: [
            ...
            {pattern: 'static/bower_components/lodash/dist/lodash.min.js', included: false },
            ...
            {pattern: 'static/bower_components/angular-translate/angular-translate.js', included: false },
            ...
            {pattern: 'static/bower_components/chosen/chosen.jquery.min.js', included: false },
            ...
            {pattern: 'static/js/**/*.js', included: false },
            {pattern: 'tests/unit/common/**/*.js', included: false },
            'tests/test-main-common.js'
        ],
