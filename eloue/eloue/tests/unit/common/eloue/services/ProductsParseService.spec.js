define(["angular-mocks", "eloue/commonApp", "eloue/services"], function () {
    ...
    describe("Service: ProductsParseService", function () {
        ...
        it("ProductsParseService:parseProduct", function () {
            var addressData = {id: 1}, ownerData = {id: 2}, ownerStatsData= {id:4},phoneData = {id: 3};
            var result = ProductsParseService.parseProduct({}, addressData, ownerData, ownerStatsData, phoneData, {});
            expect(result).toEqual({address: addressData, owner: ownerData, ownerStats: ownerStatsData, phone: phoneData});
        });
    });
});