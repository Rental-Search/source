...
from accounts.views import (dashboard, patron_edit, patron_edit_password,
    ...
    OwnerBookingAuthorized, OwnerBookingPending, OwnerBookingOngoing, OwnerBookingHistory,
    BorrowerBookingAuthorized, BorrowerBookingPending, BorrowerBookingOngoing, BorrowerBookingHistory,
    OwnerProduct, AlertEdit)
from products.views import product_edit, product_address_edit, product_phone_edit, product_price_edit, thread_details, archive_thread, unarchive_thread, inbox, archived
from rent.views import (booking_accept, booking_cancel, booking_reject, 
    booking_incident, booking_close, booking_read, BookingDetail)
...
urlpatterns = patterns('',
    ...
    url(r'^account/credit_card/$', 'accounts.views.patron_edit_credit_card', name="patron_edit_credit_card"),
    url(
        r'^account/openings/$', 
        'accounts.views.patron_edit_opening_times',
        name="patron_edit_opening_times",),
    url(
        r'^account/credit_card/delete/$', 
        'accounts.views.patron_delete_credit_card', 
        name="patron_delete_credit_card"),
    url(r'^account/rib/$', 'accounts.views.patron_edit_rib', name='patron_edit_rib'),
    ...
    url(r'^account/pro_account/subscription/$', 'accounts.views.patron_edit_subscription', name="patron_edit_subscription"),
    url(r'^account/pro_account/billing/$', 'accounts.views.billing', name="billing"),
    url(
        r'account/pro_account/billing/(?P<year>\d{4})/(?P<month>\d{2})/(?P<day>\d{2})/',
        'accounts.views.billing_object',
        name="billing_object"
        ),
    url(r'^account/pro_option/highlight/$', 'accounts.views.patron_edit_highlight', name='patron_edit_highlight'),
    url(r'^account/pro_option/notification/$', 'accounts.views.patron_edit_notification', name='patron_edit_notification'),
    url(r'^account/pro_option/top_position/$', 'accounts.views.patron_edit_top_position', name='patron_edit_top_position'),
    url(r'^account/idn/$', 'accounts.views.patron_edit_idn_connect', name='patron_edit_idn_connect'),
    url(r'^account/idn/delete/$', 'accounts.views.patron_delete_idn_connect', name='patron_delete_idn_connect'),
    ...
    url(r'^owner/product/(?P<slug>[-\w]+)-(?P<product_id>\d+)/highlight/$', 'products.views.product_highlight_edit', name="owner_product_highlight_edit"),
    url(r'^owner/product/(?P<slug>[-\w]+)-(?P<product_id>\d+)/top_position/$', 'products.views.product_top_position_edit', name="owner_product_top_position_edit"),
    ...
    url(r'^booking/(?P<booking_id>[0-9a-f]{32})/comment/$', 'accounts.views.comment_booking', name="comment_booking"),
    url(r'^booking/(?P<booking_id>[0-9a-f]{32})/view_comment/$', 'accounts.views.view_comment', name="view_comment"),
    ...
    url(r'^booking/(?P<booking_id>[0-9a-f]{32})/contract/$', 'rent.views.booking_contract', name="booking_contract"),
