...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column('products_productrelatedmessage', 'product', self.gf('django.db.models.fields.related.ForeignKey')(related_name='messages_will_be_removed', null=True, to=orm['products.Product'], blank=True), keep_default=False)
