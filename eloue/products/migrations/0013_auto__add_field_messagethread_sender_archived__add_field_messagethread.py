...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MessageThread.sender_archived'
        db.add_column('products_messagethread', 'sender_archived', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'MessageThread.recipient_archived'
        db.add_column('products_messagethread', 'recipient_archived', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MessageThread.sender_archived'
        db.delete_column('products_messagethread', 'sender_archived')

        # Deleting field 'MessageThread.recipient_archived'
        db.delete_column('products_messagethread', 'recipient_archived')
