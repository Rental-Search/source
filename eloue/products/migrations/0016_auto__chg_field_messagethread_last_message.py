...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'MessageThread.last_message'
        raise RuntimeError("Cannot reverse this migration. 'MessageThread.last_message' and its values cannot be restored.")
    ...
    models = {
        ...
        'products.messagethread': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_message': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['products.ProductRelatedMessage']", 'null': 'True', 'blank': 'True'}),
