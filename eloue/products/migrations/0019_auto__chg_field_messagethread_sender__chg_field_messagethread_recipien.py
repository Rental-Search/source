...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('products_messagethread', 'sender_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.Patron']))

        # Changing field 'MessageThread.recipient'
        db.alter_column('products_messagethread', 'recipient_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.Patron']))

        # Changing field 'ProductRelatedMessage.offer'
        db.alter_column('products_productrelatedmessage', 'offer_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['rent.Booking']))

        # Adding unique constraint on 'ProductRelatedMessage', fields ['offer']
        db.create_unique('products_productrelatedmessage', ['offer_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'ProductRelatedMessage', fields ['offer']
        db.delete_unique('products_productrelatedmessage', ['offer_id'])

        # Changing field 'MessageThread.sender'
        db.alter_column('products_messagethread', 'sender_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'MessageThread.recipient'
        db.alter_column('products_messagethread', 'recipient_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'ProductRelatedMessage.offer'
        db.alter_column('products_productrelatedmessage', 'offer_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rent.Booking'], null=True))
