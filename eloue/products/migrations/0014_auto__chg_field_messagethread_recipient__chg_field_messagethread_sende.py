...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MessageThread.recipient'
        db.alter_column('products_messagethread', 'recipient_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['auth.User']))

        # Changing field 'MessageThread.sender'
        db.alter_column('products_messagethread', 'sender_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['auth.User']))

        # Changing field 'ProductRelatedMessage.thread'
        db.alter_column('products_productrelatedmessage', 'thread_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['products.MessageThread']))


    def backwards(self, orm):
        
        # Changing field 'MessageThread.recipient'
        db.alter_column('products_messagethread', 'recipient_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'MessageThread.sender'
        db.alter_column('products_messagethread', 'sender_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'ProductRelatedMessage.thread'
        db.alter_column('products_productrelatedmessage', 'thread_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['products.MessageThread']))
