...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('products_carproduct', (
            ...
            ('comsumption', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=2)),
            ('air_conditioning', self.gf('django.db.models.fields.BooleanField')(default=False)),
    ...
    models = {
        ...
        'products.carproduct': {
            ...
            'comsumption': ('django.db.models.fields.DecimalField', [], {'max_digits': '5', 'decimal_places': '2'}),
