...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MessageThread.last_message'
        db.add_column('products_messagethread', 'last_message', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['products.ProductRelatedMessage']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MessageThread.last_message'
        db.delete_column('products_messagethread', 'last_message_id')
    ...
    models = {
        ...
        'products.messagethread': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_message': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['products.ProductRelatedMessage']"}),
