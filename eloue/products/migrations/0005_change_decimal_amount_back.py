...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        db.alter_column('products_price', 'amount', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2))

        # Changing field 'Product.deposit_amount'
        db.alter_column('products_product', 'deposit_amount', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Product.deposit_amount'
        db.alter_column('products_product', 'deposit_amount', self.gf('django.db.models.fields.DecimalField')(max_digits=8, decimal_places=4))
