...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('products_realestateproduct', (
            ...
            ('private_life', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('chamber_number', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('rules', self.gf('django.db.models.fields.CharField')(max_length=60, null=True, blank=True)),
            ('air_conditioning', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('breakfast', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('balcony', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('lockable_chamber', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('towel', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('lift', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('family_friendly', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('gym', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('accessible', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('heating', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('jacuzzi', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('chimney', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('internet_access', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('kitchen', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('parking', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('smoking_accepted', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('ideal_for_events', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('tv', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('washing_machine', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('tumble_dryer', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('computer_with_internet', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
        ))
        ...
        db.create_table('products_carproduct', (
            ...
            ('seat_number', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('door_number', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('fuel', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('transmission', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('mileage', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('consumption', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2, blank=True)),
            ('air_conditioning', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('power_steering', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('cruise_control', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('gps', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('baby_seat', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('roof_box', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('bike_rack', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('snow_tires', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('snow_chains', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('ski_rack', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('cd_player', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('audio_input', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
    ...
    models = {
        ...
        'products.carproduct': {
            ...
            'consumption': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '5', 'decimal_places': '2', 'blank': 'True'}),
            'cruise_control': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
            'door_number': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'mileage': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'seat_number': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
        ...
        'products.realestateproduct': {
            ...
            'chamber_number': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'private_life': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'product_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['products.Product']", 'unique': 'True', 'primary_key': 'True'}),
            'rules': ('django.db.models.fields.CharField', [], {'max_length': '60', 'null': 'True', 'blank': 'True'}),
