...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'MessageThread.recipient'
        db.alter_column('products_messagethread', 'recipient_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['accounts.Patron']))

        # Changing field 'MessageThread.sender'
        db.alter_column('products_messagethread', 'sender_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['accounts.Patron']))
    ...
    models = {
        ...
        'products.messagethread': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'recipient': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'participating_threads'", 'null': 'True', 'to': "orm['auth.User']"}),
            'sender': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'initiated_threads'", 'null': 'True', 'to': "orm['auth.User']"})
        },
