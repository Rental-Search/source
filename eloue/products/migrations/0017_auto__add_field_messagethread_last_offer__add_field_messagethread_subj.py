...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MessageThread.last_offer'
        db.add_column('products_messagethread', 'last_offer', self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name='last_offer_in_thread', unique=True, null=True, to=orm['products.ProductRelatedMessage']), keep_default=False)

        # Adding field 'MessageThread.subject'
        db.add_column('products_messagethread', 'subject', self.gf('django.db.models.fields.CharField')(default='', max_length=120), keep_default=False)

        # Changing field 'MessageThread.last_message'
        db.alter_column('products_messagethread', 'last_message_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['products.ProductRelatedMessage']))

        # Adding unique constraint on 'MessageThread', fields ['last_message']
        db.create_unique('products_messagethread', ['last_message_id'])

        # Adding field 'ProductRelatedMessage.offer'
        db.add_column('products_productrelatedmessage', 'offer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rent.Booking'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Removing unique constraint on 'MessageThread', fields ['last_message']
        db.delete_unique('products_messagethread', ['last_message_id'])

        # Deleting field 'MessageThread.last_offer'
        db.delete_column('products_messagethread', 'last_offer_id')

        # Deleting field 'MessageThread.subject'
        db.delete_column('products_messagethread', 'subject')

        # Changing field 'MessageThread.last_message'
        db.alter_column('products_messagethread', 'last_message_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['products.ProductRelatedMessage'], null=True))
    ...
    models = {
        ...
        'products.messagethread': {
            ...
            'recipient': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'participating_threads'", 'to': "orm['auth.User']"}),
            'sender': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'initiated_threads'", 'to': "orm['auth.User']"}),
            'subject': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '120'})
        },
        ...
        'products.productrelatedmessage': {
            ...
            'offer': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['rent.Booking']", 'null': 'True', 'blank': 'True'}),
            'product': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'messages'", 'null': 'True', 'to': "orm['products.Product']"}),
            'thread': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'messages'", 'to': "orm['products.MessageThread']"})
        },
