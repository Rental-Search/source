...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MessageThread.sender'
        db.add_column('products_messagethread', 'sender', self.gf('django.db.models.fields.related.ForeignKey')(related_name='initiated_threads', null=True, to=orm['accounts.Patron']), keep_default=False)

        # Adding field 'MessageThread.recipient'
        db.add_column('products_messagethread', 'recipient', self.gf('django.db.models.fields.related.ForeignKey')(related_name='participating_threads', null=True, to=orm['accounts.Patron']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MessageThread.sender'
        db.delete_column('products_messagethread', 'sender_id')

        # Deleting field 'MessageThread.recipient'
        db.delete_column('products_messagethread', 'recipient_id')
    ...
    models = {
        ...
        'products.messagethread': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'recipient': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'participating_threads'", 'null': 'True', 'to': "orm['accounts.Patron']"}),
            'sender': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'initiated_threads'", 'null': 'True', 'to': "orm['accounts.Patron']"})
        },
