...
class ProductForm(BetterModelForm):
    ...
    shipping = forms.BooleanField(label=_(u"Livraison possible"), required=False, initial=False, widget=CommentedCheckboxInput(info_text='J\'accepte de livrer partout en France. (Service disponible à partir de septembre)'))
