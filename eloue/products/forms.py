...
class ProductForm(forms.ModelForm):
    ...
    hour_price = forms.DecimalField(label=_(u"l'heure"), required=False, min_value=1, widget=forms.TextInput(attrs={'class': 'ins'}), localize=True)
    day_price = forms.DecimalField(label=_(u"la journée"), required=True, min_value=1, widget=forms.TextInput(attrs={'class': 'ins'}), localize=True)
    week_end_price = forms.DecimalField(label=_(u"le week-end"), required=False, min_value=1, widget=forms.TextInput(attrs={'class': 'ins'}), localize=True)
    week_price = forms.DecimalField(label=_(u"la semaine"), required=False, min_value=1, widget=forms.TextInput(attrs={'class': 'ins'}), localize=True)
    two_weeks_price = forms.DecimalField(label=_(u"les 15 jours"), required=False, min_value=1, widget=forms.TextInput(attrs={'class': 'ins'}), localize=True)
    month_price = forms.DecimalField(label=_(u"le mois"), required=False, min_value=1, widget=forms.TextInput(attrs={'class': 'ins'}), localize=True)
