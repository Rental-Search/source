...
urlpatterns = patterns('',
    ...
    url(r'^products_feed/$', 'products.views.product_xml_list_criteo', name='product_xml_list_criteo'),
    url(r'^products_feed_sg/$', 'products.views.product_xml_list_snowglobe', name='product_xml_list_snowglobe'),
