...
from eloue.products.views import product_create, product_list, product_edit, message_edit, reply_product_related_message
...
urlpatterns = patterns('',
    ...
    url(r'^(?P<product_id>\d+)/message_edit/$', message_edit, name="message_edit"),
