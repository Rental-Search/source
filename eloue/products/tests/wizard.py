...
class ProductWizardTestWithFacebookAccount(TestCase):
    ...
    def test_second_step_as_not_logged_in(self, mock_method):
    ...
    @patch.object(MultiPartFormWizard, 'security_hash')
    def test_third_step_as_not_logged_in(self, mock_method):
        mock_method.return_value = '6941fd7b20d720833717a1f92e8027af'
        uid = 100003207275288
        access_token = 'AAAC0EJC00lQBAOf7XANWgcw2UzKdLn5q13bUp07KRPy8MntAdsPzJsnFOiCu7ZCegQIX46eu7OAjXp3sFucTCRKYGH42OW9ywcissIAZDZD'
        response = self.client.post(reverse('product_create'), {
    ...
    @patch.object(MultiPartFormWizard, 'security_hash')
    def test_second_step_as_new_user(self, mock_method):
        mock_method.return_value = '6941fd7b20d720833717a1f92e8027af'
        uid = 100000609837182
    ...
    @patch.object(MultiPartFormWizard, 'security_hash')
    def test_third_step_as_new_user(self, mock_method):
        mock_method.return_value = '6941fd7b20d720833717a1f92e8027af'
        uid = 100000609837182
        access_token = 'AAAC0EJC00lQBAGnc6FW8QlB5tz4ppuSXeR0FQ8kdCagwHwRraHDBI4HE7eigTprugjh0uGPu4h2FG2VEaRO8RxRcm8ObicNyZB21JGgZDZD'
        with self.assertRaises(FacebookSession.DoesNotExist):
    ...
    @patch.object(MultiPartFormWizard, 'security_hash')
    def test_second_step_associate_accounts(self, mock_method):
        mock_method.return_value = '6941fd7b20d720833717a1f92e8027af'
        uid = 100003190074813
    ...
    @patch.object(MultiPartFormWizard, 'security_hash')
    def test_third_step_associate_accounts(self, mock_method):
        mock_method.return_value = '6941fd7b20d720833717a1f92e8027af'
        uid = 100003190074813
        access_token = 'AAAC0EJC00lQBAFeztcpDKBgyFDRm9kIiaSe7amtYzcw2MLiSdfEeh9ftpZAFzYUT0zwIqXCnBEYe95I1cnMX8dZCQ2Dw10qJlhJRgYxgZDZD'
        self.assertEqual(FacebookSession.objects.get(uid=uid).user, None)
...
class MessageWizardTestWithFacebook(TestCase):
    ...
    def test_zero_step_logged_out(self):
        access_token = "AAAC0EJC00lQBAOf7XANWgcw2UzKdLn5q13bUp07KRPy8MntAdsPzJsnFOiCu7ZCegQIX46eu7OAjXp3sFucTCRKYGH42OW9ywcissIAZDZD"
        uid = 100003207275288
    ...
    @patch.object(MultiPartFormWizard, 'security_hash')
    def test_first_step_logged_out(self, mock_method):
        mock_method.return_value = '6941fd7b20d720833717a1f92e8027af'
        access_token = "AAAC0EJC00lQBAOf7XANWgcw2UzKdLn5q13bUp07KRPy8MntAdsPzJsnFOiCu7ZCegQIX46eu7OAjXp3sFucTCRKYGH42OW9ywcissIAZDZD"
        uid = 100003207275288
        response = self.client.post(reverse('message_create', kwargs={'product_id':self.product.pk, 'recipient_id': self.product.owner.pk}), {
    ...
    @patch.object(MultiPartFormWizard, 'security_hash')
    def test_first_step_new_user(self, mock_method):
        mock_method.return_value = '6941fd7b20d720833717a1f92e8027af'
        access_token = 'AAAC0EJC00lQBAGnc6FW8QlB5tz4ppuSXeR0FQ8kdCagwHwRraHDBI4HE7eigTprugjh0uGPu4h2FG2VEaRO8RxRcm8ObicNyZB21JGgZDZD'
        uid = 100000609837182
        response = self.client.post(reverse('message_create', kwargs={'product_id':self.product.pk, 'recipient_id': self.product.owner.pk}), {
    ...
    @patch.object(MultiPartFormWizard, 'security_hash')
    def test_second_step_new_user(self, mock_method):
        mock_method.return_value = '6941fd7b20d720833717a1f92e8027af'
        access_token = 'AAAC0EJC00lQBAGnc6FW8QlB5tz4ppuSXeR0FQ8kdCagwHwRraHDBI4HE7eigTprugjh0uGPu4h2FG2VEaRO8RxRcm8ObicNyZB21JGgZDZD'
        uid = 100000609837182
        response = self.client.post(reverse('message_create', kwargs={'product_id':self.product.pk, 'recipient_id': self.product.owner.pk}), {
    ...
    @patch.object(MultiPartFormWizard, 'security_hash')
    def test_third_step_new_user(self, mock_method):
        mock_method.return_value = '6941fd7b20d720833717a1f92e8027af'
        access_token = 'AAAC0EJC00lQBAGnc6FW8QlB5tz4ppuSXeR0FQ8kdCagwHwRraHDBI4HE7eigTprugjh0uGPu4h2FG2VEaRO8RxRcm8ObicNyZB21JGgZDZD'
        uid = 100000609837182
        response = self.client.post(reverse('message_create', kwargs={'product_id':self.product.pk, 'recipient_id': self.product.owner.pk}), {
    ...
    @patch.object(MultiPartFormWizard, 'security_hash')
    def test_second_step_associate_user(self, mock_method):
        mock_method.return_value = '6941fd7b20d720833717a1f92e8027af'
        access_token = 'AAAC0EJC00lQBAFeztcpDKBgyFDRm9kIiaSe7amtYzcw2MLiSdfEeh9ftpZAFzYUT0zwIqXCnBEYe95I1cnMX8dZCQ2Dw10qJlhJRgYxgZDZD'
        uid = 100003190074813
        response = self.client.post(reverse('message_create', kwargs={'product_id':self.product.pk, 'recipient_id': self.product.owner.pk}), {
