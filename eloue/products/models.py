...
class CarProduct(Product):
    ...
    seat_number = models.IntegerField(_(u'nombre de place'))
    door_number = models.IntegerField(_(u'nombre de porte'))
...
class RealEstateProduct(Product):
    ...
    chamber_number = models.IntegerField(_(u'nombre de chambre'))
    rules = models.CharField(_(u"règle d'utilisation"), max_length=60)
