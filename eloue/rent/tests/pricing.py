...
class BookingPriceTest(TestCase):
    ...
    def test_calculate_hours_price(self):
        ...
        #self.assertEqual(timesince(started_at, ended_at), u', '.join(["4 "+ _(u"minutes")]))
        #self.assertEqual(timesince(ended_at, started_at), u', '.join(["0 "+ _(u"minutes")]))
    ...
    def test_calculate_week_end_price(self):
        ...
        #self.assertEqual(timesince(started_at, ended_at), u', '.join(["3 "+ _(u"jours")]))
        unit, price = Booking.calculate_price(self.product, started_at, ended_at)
    ...
    def test_calculate_day_price(self):
        ...
        #self.assertEqual(timesince(started_at, ended_at), u', '.join(["4 "+ _(u"jours")]))
        unit, price = Booking.calculate_price(self.product, started_at, ended_at)
    ...
    def test_calculate_week_price(self):
        ...
        #self.assertEqual(timesince(started_at, ended_at), u', '.join(["1 "+ _(u"semaines")]))
        unit, price = Booking.calculate_price(self.product, started_at, ended_at)
    ...
    def test_calculate_two_weeks_price(self):
        ...
        #self.assertEqual(timesince(started_at, ended_at), u', '.join(["2 "+ _(u"semaines")]))
        unit, price = Booking.calculate_price(self.product, started_at, ended_at)
    ...
    def test_calculate_leap_two_weeks(self):
        ...
        #self.assertEqual(timesince(started_at, ended_at), u', '.join(["4 "+ _(u"semaines"), "1 " + _(u"jour")]))
        unit, price = Booking.calculate_price(self.product, started_at, ended_at)
        self.assertEquals(price, D('279.64'))
        self.assertEquals(unit, UNIT.TWO_WEEKS)
        started_at = datetime(2011, 3, 4, 9)
        ended_at = started_at + timedelta(days=30)
        #self.assertEqual(timesince(started_at, ended_at), u', '.join(["1 "+ _(u"mois")]))
        unit, price = Booking.calculate_price(self.product, started_at, ended_at)
    ...
    def test_calculate_leap_month(self):
        ...
        #self.assertEqual(timesince(started_at, ended_at), u', '.join(["4 "+ _(u"semaines")]))
        unit, price = Booking.calculate_price(self.product, started_at, ended_at)
    ...
    def test_calculate_month_price(self):
        ...
        #self.assertEqual(timesince(started_at, ended_at), u', '.join(["1 "+ _(u"mois"), "2 "+_(u"semaines"), "1 " + _(u"jour")]))
        unit, price = Booking.calculate_price(self.product, started_at, ended_at)
    ...
    def test_calculate_hourly_price(self):
        ...
        #self.assertEqual(timesince(started_at, ended_at), u', '.join(["6 "+ _(u"minutes")]))
        unit, price = Booking.calculate_price(product, started_at, ended_at)
    ...
    def test_calculate_two_week_price(self):
        ...
        #self.assertEqual(timesince(started_at, ended_at), u', '.join(["2 "+ _(u"semaines"), "4 "+_(u"jours")]))
        unit, price = Booking.calculate_price(product, started_at, ended_at)
    ...
    def test_calculate_strict_day_price(self):
        ...
        #self.assertEqual(timesince(started_at, ended_at), u', '.join(["1 "+ _(u"jour")]))
        unit, price = Booking.calculate_price(product, started_at, ended_at)
    ...
    def test_calculate_strict_day_with_hours_price(self):
        ...
        #self.assertEqual(timesince(started_at, ended_at), u', '.join(["1 "+ _(u"jour"), "4 "+_(u"heures")]))
        unit, price = Booking.calculate_price(product, started_at, ended_at)
    ...
    def test_calculate_strict_with_hours_price(self):
        ...
        #self.assertEqual(timesince(started_at, ended_at), u', '.join(["4 "+_(u"heures")]))
        unit, price = Booking.calculate_price(product, started_at, ended_at)
