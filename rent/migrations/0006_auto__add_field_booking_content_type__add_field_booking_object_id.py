...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Booking.content_type'
        db.add_column('rent_booking', 'content_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'], null=True, blank=True), keep_default=False)

        # Adding field 'Booking.object_id'
        db.add_column('rent_booking', 'object_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Booking.content_type'
        db.delete_column('rent_booking', 'content_type_id')

        # Deleting field 'Booking.object_id'
        db.delete_column('rent_booking', 'object_id')
