...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Booking.quantity'
        db.add_column('rent_booking', 'quantity', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Booking.quantity'
        db.delete_column('rent_booking', 'quantity')
