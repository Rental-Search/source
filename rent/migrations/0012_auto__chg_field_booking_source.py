...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Booking.source'
        db.alter_column(u'rent_booking', 'source_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sites.Site'], null=True))

    def backwards(self, orm):

        # Changing field 'Booking.source'
        db.alter_column(u'rent_booking', 'source_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['sites.Site']))
    ...
    models = {
        ...
        u'rent.bookinglog': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'source_state': ('django_fsm.FSMField', [], {'max_length': '50'}),
            'target_state': ('django_fsm.FSMField', [], {'max_length': '50'})
        },
        u'rent.comment': {
