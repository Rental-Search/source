...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'OwnerComment'
        db.create_table('rent_ownercomment', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('booking', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['rent.Booking'], unique=True)),
            ('comment', self.gf('django.db.models.fields.TextField')()),
            ('note', self.gf('django.db.models.fields.PositiveSmallIntegerField')()),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('rent', ['OwnerComment'])

        # Adding model 'BorrowerComment'
        db.create_table('rent_borrowercomment', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('booking', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['rent.Booking'], unique=True)),
            ('comment', self.gf('django.db.models.fields.TextField')()),
            ('note', self.gf('django.db.models.fields.PositiveSmallIntegerField')()),
        ...
        db.send_create_signal('rent', ['BorrowerComment'])


    def backwards(self, orm):
        
        # Deleting model 'OwnerComment'
        db.delete_table('rent_ownercomment')

        # Deleting model 'BorrowerComment'
        db.delete_table('rent_borrowercomment')
    ...
    models = {
        ...
        'rent.borrowercomment': {
            'Meta': {'object_name': 'BorrowerComment'},
