...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Booking.source
        db.add_column(u'rent_booking', 'source',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['sites.Site']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Booking.source'
        db.delete_column(u'rent_booking', 'source_id')
    ...
    models = {
        ...
        u'rent.booking': {
            ...
            'source': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['sites.Site']"}),
