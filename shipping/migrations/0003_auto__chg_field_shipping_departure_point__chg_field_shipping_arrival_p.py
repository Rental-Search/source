...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Shipping.departure_point'
        db.alter_column(u'shipping_shipping', 'departure_point_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.PROTECT, to=orm['shipping.ProductShippingPoint']))

        # Changing field 'Shipping.arrival_point'
        db.alter_column(u'shipping_shipping', 'arrival_point_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.PROTECT, to=orm['shipping.PatronShippingPoint']))

    def backwards(self, orm):

        # Changing field 'Shipping.departure_point'
        db.alter_column(u'shipping_shipping', 'departure_point_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.PROTECT, to=orm['shipping.ShippingPoint']))

        # Changing field 'Shipping.arrival_point'
        db.alter_column(u'shipping_shipping', 'arrival_point_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.PROTECT, to=orm['shipping.ShippingPoint']))
