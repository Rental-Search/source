...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for record in orm.PatronShippingPoint.objects.exclude(shipping__isnull=True):
            booking = record.shipping
            record.shipping = None
            record.save()
            record.booking = booking
            record.save()

    def backwards(self, orm):
        for record in orm.PatronShippingPoint.objects.exclude(booking__isnull=True):
