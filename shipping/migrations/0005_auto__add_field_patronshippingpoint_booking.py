...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PatronShippingPoint.booking'
        db.add_column(u'shipping_patronshippingpoint', 'booking',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['rent.Booking'], unique=True, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PatronShippingPoint.booking'
        db.delete_column(u'shipping_patronshippingpoint', 'booking_id')
    ...
    models = {
        ...
        u'shipping.patronshippingpoint': {
            ...
            'booking': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['rent.Booking']", 'unique': 'True', 'null': 'True'}),
            'patron': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'shipping_points'", 'to': u"orm['accounts.Patron']"}),
            'shipping': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'arrival_point'", 'unique': 'True', 'null': 'True', 'to': u"orm['rent.Booking']"}),
