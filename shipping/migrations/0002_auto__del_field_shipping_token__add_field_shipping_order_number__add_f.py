...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Shipping.token'
        db.delete_column(u'shipping_shipping', 'token')

        # Adding field 'Shipping.order_number'
        db.add_column(u'shipping_shipping', 'order_number',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128),
                      keep_default=False)

        # Adding field 'Shipping.shuttle_code'
        db.add_column(u'shipping_shipping', 'shuttle_code',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128),
                      keep_default=False)

        # Adding field 'Shipping.shuttle_document_url'
        db.add_column(u'shipping_shipping', 'shuttle_document_url',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1024),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Shipping.token'
        db.add_column(u'shipping_shipping', 'token',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128),
                      keep_default=False)

        # Deleting field 'Shipping.order_number'
        db.delete_column(u'shipping_shipping', 'order_number')

        # Deleting field 'Shipping.shuttle_code'
        db.delete_column(u'shipping_shipping', 'shuttle_code')

        # Deleting field 'Shipping.shuttle_document_url'
        db.delete_column(u'shipping_shipping', 'shuttle_document_url')
