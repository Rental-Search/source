...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ShippingPoint'
        db.create_table(u'shipping_shippingpoint', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('site_id', self.gf('django.db.models.fields.BigIntegerField')()),
            ('pudo_id', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('position', self.gf('django.contrib.gis.db.models.fields.PointField')()),
            ('type', self.gf('django.db.models.fields.SmallIntegerField')()),
        ))
        db.send_create_signal(u'shipping', ['ShippingPoint'])

        # Adding model 'PatronShippingPoint'
        db.create_table(u'shipping_patronshippingpoint', (
            (u'shippingpoint_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['shipping.ShippingPoint'], unique=True, primary_key=True)),
            ('patron', self.gf('django.db.models.fields.related.ForeignKey')(related_name='shipping_points', to=orm['accounts.Patron'])),
        ))
        db.send_create_signal(u'shipping', ['PatronShippingPoint'])

        # Adding model 'ProductShippingPoint'
        db.create_table(u'shipping_productshippingpoint', (
            (u'shippingpoint_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['shipping.ShippingPoint'], unique=True, primary_key=True)),
            ('product', self.gf('django.db.models.fields.related.OneToOneField')(related_name='shipping_point', unique=True, to=orm['products.Product'])),
        ))
        db.send_create_signal(u'shipping', ['ProductShippingPoint'])

        # Adding model 'Shipping'
        db.create_table(u'shipping_shipping', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('booking', self.gf('django.db.models.fields.related.OneToOneField')(related_name='shipping', unique=True, to=orm['rent.Booking'])),
            ('departure_point', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', on_delete=models.PROTECT, to=orm['shipping.ShippingPoint'])),
            ('arrival_point', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', on_delete=models.PROTECT, to=orm['shipping.ShippingPoint'])),
            ('price', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2)),
            ('token', self.gf('django.db.models.fields.CharField')(max_length=128)),
        ))
        db.send_create_signal(u'shipping', ['Shipping'])


    def backwards(self, orm):
        # Deleting model 'ShippingPoint'
        db.delete_table(u'shipping_shippingpoint')

        # Deleting model 'PatronShippingPoint'
        db.delete_table(u'shipping_patronshippingpoint')

        # Deleting model 'ProductShippingPoint'
        db.delete_table(u'shipping_productshippingpoint')

        # Deleting model 'Shipping'
        db.delete_table(u'shipping_shipping')
    ...
    models = {
        ...
        u'shipping.patronshippingpoint': {
            'Meta': {'object_name': 'PatronShippingPoint', '_ormbases': [u'shipping.ShippingPoint']},
            'patron': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'shipping_points'", 'to': u"orm['accounts.Patron']"}),
            u'shippingpoint_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['shipping.ShippingPoint']", 'unique': 'True', 'primary_key': 'True'})
        },
        u'shipping.productshippingpoint': {
            'Meta': {'object_name': 'ProductShippingPoint', '_ormbases': [u'shipping.ShippingPoint']},
            'product': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'shipping_point'", 'unique': 'True', 'to': u"orm['products.Product']"}),
            u'shippingpoint_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['shipping.ShippingPoint']", 'unique': 'True', 'primary_key': 'True'})
        },
        u'shipping.shipping': {
            'Meta': {'object_name': 'Shipping'},
            'arrival_point': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'on_delete': 'models.PROTECT', 'to': u"orm['shipping.ShippingPoint']"}),
            'booking': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'shipping'", 'unique': 'True', 'to': u"orm['rent.Booking']"}),
            'departure_point': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'on_delete': 'models.PROTECT', 'to': u"orm['shipping.ShippingPoint']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'price': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '2'}),
            'token': ('django.db.models.fields.CharField', [], {'max_length': '128'})
        },
        u'shipping.shippingpoint': {
            'Meta': {'object_name': 'ShippingPoint'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'position': ('django.contrib.gis.db.models.fields.PointField', [], {}),
            'pudo_id': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
            'site_id': ('django.db.models.fields.BigIntegerField', [], {}),
