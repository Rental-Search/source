define(["angular", "eloue/resources", "eloue/modules/booking/BookingModule"], function (angular) {
     ...
     * Product service.
     */
    angular.module("EloueApp.BookingModule").factory("ProductService", ["$q", "Products", "CheckAvailability", "Users", "Addresses", "PhoneNumbers", function ($q, Products, CheckAvailability, Users, Addresses, PhoneNumbers) {
