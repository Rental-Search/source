...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CreditCard.holder_name'
        db.add_column('accounts_creditcard', 'holder_name', self.gf('django.db.models.fields.CharField')(default='', max_length=60), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CreditCard.holder_name'
        db.delete_column('accounts_creditcard', 'holder_name')
