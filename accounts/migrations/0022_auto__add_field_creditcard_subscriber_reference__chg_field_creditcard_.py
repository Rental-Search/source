...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CreditCard.subscriber_reference'
        db.add_column('accounts_creditcard', 'subscriber_reference', self.gf('django.db.models.fields.CharField')(default='', max_length=250, blank=True), keep_default=False)

        # Changing field 'CreditCard.holder'
        db.alter_column('accounts_creditcard', 'holder_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['accounts.Patron'], unique=True, null=True))

        # Changing field 'Avatar.created_at'
        db.alter_column('accounts_avatar', 'created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))


    def backwards(self, orm):
        
        # Deleting field 'CreditCard.subscriber_reference'
        db.delete_column('accounts_creditcard', 'subscriber_reference')

        # User chose to not deal with backwards NULL issues for 'CreditCard.holder'
        raise RuntimeError("Cannot reverse this migration. 'CreditCard.holder' and its values cannot be restored.")

        # Changing field 'Avatar.created_at'
        db.alter_column('accounts_avatar', 'created_at', self.gf('django.db.models.fields.DateTimeField')())
