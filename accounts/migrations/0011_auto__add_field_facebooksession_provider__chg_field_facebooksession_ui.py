...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FacebookSession.provider'
        db.add_column('accounts_facebooksession', 'provider', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1), keep_default=False)

        # Changing field 'FacebookSession.uid'
        db.alter_column('accounts_facebooksession', 'uid', self.gf('django.db.models.fields.CharField')(max_length=255, unique=True, null=True))


    def backwards(self, orm):
        
        # Deleting field 'FacebookSession.provider'
        db.delete_column('accounts_facebooksession', 'provider')

        # Changing field 'FacebookSession.uid'
        db.alter_column('accounts_facebooksession', 'uid', self.gf('django.db.models.fields.BigIntegerField')(unique=True, null=True))
