...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ProAgency'
        db.create_table('accounts_proagency', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('patron', self.gf('django.db.models.fields.related.ForeignKey')(related_name='pro_agencies', to=orm['accounts.Patron'])),
        ...
        db.send_create_signal('accounts', ['ProAgency'])


    def backwards(self, orm):
        
        # Deleting model 'ProAgency'
        db.delete_table('accounts_proagency')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 30, 15, 4, 37, 60853)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 30, 15, 4, 37, 60731)'}),
