...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Patron.device_token'
        db.add_column(u'accounts_patron', 'device_token',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Patron.device_token'
        db.delete_column(u'accounts_patron', 'device_token')
