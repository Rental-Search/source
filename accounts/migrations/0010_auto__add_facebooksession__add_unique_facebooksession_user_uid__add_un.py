...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('accounts_facebooksession', (
        ...
        db.send_create_signal('accounts', ['FacebookSession'])

        # Adding unique constraint on 'FacebookSession', fields ['user', 'uid']
        db.create_unique('accounts_facebooksession', ['user_id', 'uid'])

        # Adding unique constraint on 'FacebookSession', fields ['access_token', 'expires']
        db.create_unique('accounts_facebooksession', ['access_token', 'expires'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'FacebookSession', fields ['access_token', 'expires']
        db.delete_unique('accounts_facebooksession', ['access_token', 'expires'])

        # Removing unique constraint on 'FacebookSession', fields ['user', 'uid']
        db.delete_unique('accounts_facebooksession', ['user_id', 'uid'])

        # Deleting model 'FacebookSession'
        db.delete_table('accounts_facebooksession')
