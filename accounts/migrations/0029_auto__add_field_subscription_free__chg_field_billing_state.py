...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Subscription.free'
        db.add_column('accounts_subscription', 'free', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Changing field 'Billing.state'
        db.alter_column('accounts_billing', 'state', self.gf('django_fsm.db.fields.fsmfield.FSMField')(max_length=50))


    def backwards(self, orm):
        
        # Deleting field 'Subscription.free'
        db.delete_column('accounts_subscription', 'free')

        # Changing field 'Billing.state'
        db.alter_column('accounts_billing', 'state', self.gf('django.db.models.fields.CharField')(max_length=50))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 30, 16, 26, 38, 742443)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 30, 16, 26, 38, 742331)'}),
