...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PatronAccepted'
        db.create_table('accounts_patronaccepted', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('email', self.gf('django.db.models.fields.EmailField')(max_length=75)),
        ))
        db.send_create_signal('accounts', ['PatronAccepted'])

        # Adding M2M table for field sites on 'PatronAccepted'
        db.create_table('accounts_patronaccepted_sites', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('patronaccepted', models.ForeignKey(orm['accounts.patronaccepted'], null=False)),
            ('site', models.ForeignKey(orm['sites.site'], null=False))
        ))
        db.create_unique('accounts_patronaccepted_sites', ['patronaccepted_id', 'site_id'])


    def backwards(self, orm):
        
        # Deleting model 'PatronAccepted'
        db.delete_table('accounts_patronaccepted')

        # Removing M2M table for field sites on 'PatronAccepted'
        db.delete_table('accounts_patronaccepted_sites')
