...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Patron.default_number'
        db.add_column('accounts_patron', 'default_number', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['accounts.PhoneNumber']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Patron.default_number'
        db.delete_column('accounts_patron', 'default_number_id')
