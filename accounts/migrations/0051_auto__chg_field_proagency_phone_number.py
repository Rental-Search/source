...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProAgency.phone_number'
        db.alter_column(u'accounts_proagency', 'phone_number', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'ProAgency.phone_number'
        raise RuntimeError("Cannot reverse this migration. 'ProAgency.phone_number' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'ProAgency.phone_number'
        db.alter_column(u'accounts_proagency', 'phone_number', self.gf('django.db.models.fields.CharField')(max_length=255))
