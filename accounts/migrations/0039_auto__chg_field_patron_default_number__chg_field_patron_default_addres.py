...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Patron.default_number'
        db.alter_column(u'accounts_patron', 'default_number_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.PROTECT, to=orm['accounts.PhoneNumber']))

        # Changing field 'Patron.default_address'
        db.alter_column(u'accounts_patron', 'default_address_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.PROTECT, to=orm['accounts.Address']))

    def backwards(self, orm):

        # Changing field 'Patron.default_number'
        db.alter_column(u'accounts_patron', 'default_number_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['accounts.PhoneNumber']))

        # Changing field 'Patron.default_address'
        db.alter_column(u'accounts_patron', 'default_address_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['accounts.Address']))
