...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProAgency.state'
        db.add_column(u'accounts_proagency', 'state',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Address.state'
        db.add_column(u'accounts_address', 'state',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProAgency.state'
        db.delete_column(u'accounts_proagency', 'state')

        # Deleting field 'Address.state'
        db.delete_column(u'accounts_address', 'state')
