...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'accounts_campaign', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('pro', self.gf('django.db.models.fields.related.ForeignKey')(related_name='campaigns', to=orm['accounts.Patron'])),
        ...
        db.send_create_signal(u'accounts', ['Campaign'])


    def backwards(self, orm):
        # Deleting model 'Campaign'
        db.delete_table(u'accounts_campaign')
    ...
    models = {
        ...
        u'products.product': {
            ...
            'currency': ('django.db.models.fields.CharField', [], {'default': "'DKK'", 'max_length': '3'}),
