...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Ticket'
        db.create_table(u'accounts_ticket', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('pro', self.gf('django.db.models.fields.related.ForeignKey')(related_name='tickets', to=orm['accounts.Patron'])),
            ('agent', self.gf('django.db.models.fields.related.ForeignKey')(related_name='pro_tickets', to=orm['accounts.Patron'])),
            ('comment', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'accounts', ['Ticket'])

        # Adding model 'ProReport'
        db.create_table(u'accounts_proreport', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('pro', self.gf('django.db.models.fields.related.ForeignKey')(related_name='reports', to=orm['accounts.Patron'])),
            ('agent', self.gf('django.db.models.fields.related.ForeignKey')(related_name='pro_reports', to=orm['accounts.Patron'])),
            ('comment', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('stat', self.gf('django.db.models.fields.BooleanField')()),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'accounts', ['ProReport'])

        # Adding field 'Subscription.signed_at'
        db.add_column(u'accounts_subscription', 'signed_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Subscription.amount'
        db.add_column(u'accounts_subscription', 'amount',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Subscription.fee'
        db.add_column(u'accounts_subscription', 'fee',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding M2M table for field seller on 'Subscription'
        m2m_table_name = db.shorten_name(u'accounts_subscription_seller')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('subscription', models.ForeignKey(orm[u'accounts.subscription'], null=False)),
            ('patron', models.ForeignKey(orm[u'accounts.patron'], null=False))
        ))
        db.create_unique(m2m_table_name, ['subscription_id', 'patron_id'])


        # Changing field 'Subscription.subscription_started'
        db.alter_column(u'accounts_subscription', 'subscription_started', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):
        # Deleting model 'Ticket'
        db.delete_table(u'accounts_ticket')

        # Deleting model 'ProReport'
        db.delete_table(u'accounts_proreport')

        # Deleting field 'Subscription.signed_at'
        db.delete_column(u'accounts_subscription', 'signed_at')

        # Deleting field 'Subscription.amount'
        db.delete_column(u'accounts_subscription', 'amount')

        # Deleting field 'Subscription.fee'
        db.delete_column(u'accounts_subscription', 'fee')

        # Removing M2M table for field seller on 'Subscription'
        db.delete_table(db.shorten_name(u'accounts_subscription_seller'))


        # User chose to not deal with backwards NULL issues for 'Subscription.subscription_started'
        #raise RuntimeError("Cannot reverse this migration. 'Subscription.subscription_started' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Subscription.subscription_started'
        db.alter_column(u'accounts_subscription', 'subscription_started', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
    ...
    models = {
        ...
        u'accounts.subscription': {
            ...
            'seller': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'contracts'", 'symmetrical': 'False', 'to': u"orm['accounts.Patron']"}),
