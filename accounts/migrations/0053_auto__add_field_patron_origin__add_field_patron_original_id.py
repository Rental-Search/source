...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Patron.original_id'
        db.add_column(u'accounts_patron', 'original_id',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Patron.original_id'
        db.delete_column(u'accounts_patron', 'original_id')
    ...
    models = {
        ...
        u'accounts.patron': {
            ...
            'origin': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
