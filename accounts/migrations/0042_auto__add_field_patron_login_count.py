...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Patron.login_count'
        db.add_column(u'accounts_patron', 'login_count',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Patron.login_count'
        db.delete_column(u'accounts_patron', 'login_count')
