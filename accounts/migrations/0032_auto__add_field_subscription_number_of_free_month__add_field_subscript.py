...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Subscription.number_of_free_month'
        db.add_column('accounts_subscription', 'number_of_free_month', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Subscription.annual_payment_date'
        db.add_column('accounts_subscription', 'annual_payment_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Subscription.number_of_free_month'
        db.delete_column('accounts_subscription', 'number_of_free_month')

        # Deleting field 'Subscription.annual_payment_date'
        db.delete_column('accounts_subscription', 'annual_payment_date')
    ...
    models = {
        ...
        'accounts.openingtimes': {
            ...
            'patron': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'opening_times'", 'unique': 'True', 'to': "orm['accounts.Patron']"}),
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 16, 11, 41, 14, 704347)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 16, 11, 41, 14, 704241)'}),
