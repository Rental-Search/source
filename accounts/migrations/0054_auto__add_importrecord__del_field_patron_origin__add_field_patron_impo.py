...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'accounts_importrecord', (
            ...
            ('imported_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='import_records', null=True, to=orm['accounts.Patron'])),
        ))
        db.send_create_signal(u'accounts', ['ImportRecord'])

        # Deleting field 'Patron.origin'
        db.delete_column(u'accounts_patron', 'origin')

        # Adding field 'Patron.import_record'
        db.add_column(u'accounts_patron', 'import_record',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='patrons', null=True, to=orm['accounts.ImportRecord']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'ImportRecord'
        db.delete_table(u'accounts_importrecord')

        # Adding field 'Patron.origin'
        db.add_column(u'accounts_patron', 'origin',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Patron.import_record'
        db.delete_column(u'accounts_patron', 'import_record_id')
    ...
    models = {
        ...
        u'accounts.patron': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'import_record': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'patrons'", 'null': 'True', 'to': u"orm['accounts.ImportRecord']"}),
            ...
            'original_id': ('django.db.models.fields.BigIntegerField', [], {'null': 'True'}),
        ...
        u'products.product': {
            ...
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'import_record': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'products'", 'null': 'True', 'to': u"orm['accounts.ImportRecord']"}),
