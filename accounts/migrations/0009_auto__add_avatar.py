...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Avatar'
        db.create_table('accounts_avatar', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('patron', self.gf('django.db.models.fields.related.OneToOneField')(related_name='avatar', unique=True, to=orm['auth.User'])),
    ...
    def backwards(self, orm):
        ...
        db.delete_table('accounts_avatar')
