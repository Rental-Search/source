...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Patron.source'
        db.add_column(u'accounts_patron', 'source',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['sites.Site'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Patron.source'
        db.delete_column(u'accounts_patron', 'source_id')
