...
def symlink():
    ...
    run("ln -nfs %(current_release)s/env/lib/python2.7/site-packages/django/contrib/admin/media %(current_release)s/%(app_name)s/media/admin" % {'current_release': env.current_release, 'app_name': env.app_name})
